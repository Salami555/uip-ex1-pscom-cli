 ...
 * - make yourself familiar with semantic versioning, e.g., here https://semver.org/, if you like, since it can useful
 * for CLIs. For example, it allows to detach the version number of the CLI from the version of the library used and may
